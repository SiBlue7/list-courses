...
urlpatterns = [
    ...
    path('lists/<int:list_id>/recipes/<int:entry_id>/edit/', views.shopping_list_recipe_update, name='shopping_list_recipe_update'),
    path('lists/<int:list_id>/recipes/<int:entry_id>/remove/', views.shopping_list_recipe_remove, name='shopping_list_recipe_remove'),
